...
describe('DeleteDatabaseModal', () => {
  let component;
  beforeEach(() => {
    component = shallow(<DeleteDatabaseModal />);
  });
  ...
  describe('component with required props only', () => {
    ...
    it('has an EmptyStateIcon', () => {
      ...
      expect(emptyStateIcon.hasClass('DeleteDatabaseModal__icon')).toBe(true);
    });
    ...
    it('has an EmptyStateInfo', () => {
      ...
      expect(emptyStateInfo.hasClass('DeleteDatabaseModal__info')).toBe(true);
    });
  });

  describe('component with extra props', () => {
    it('renders info prop', () => {
      component = shallow(<DeleteDatabaseModal {...props} />);
      const title = component.find('EmptyStateTitle');
      expect(title.render().text()).toContain('database');
    });
