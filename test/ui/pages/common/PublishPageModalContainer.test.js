...
import { mapStateToProps, mapDispatchToProps } from 'ui/pages/common/PublishPageModalContainer';
...
describe('PublishPageModalContainer', () => {
  let props;
  ...
  describe('mapDispatchToProps', () => {
    it('should map the correct function properties', () => {
      ...
      expect(props.onConfirmPublish).toBeDefined();
