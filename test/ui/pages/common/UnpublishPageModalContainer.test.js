...
import { mapStateToProps, mapDispatchToProps } from 'ui/pages/common/UnpublishPageModalContainer';
...
describe('UnpublishPageModalContainer', () => {
  let props;
  ...
  describe('mapDispatchToProps', () => {
    it('should map the correct function properties', () => {
      ...
      expect(props.onConfirmUnpublish).toBeDefined();
      props.onConfirmUnpublish();
