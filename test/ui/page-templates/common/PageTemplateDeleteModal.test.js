...
describe('PageTemplateDeleteModal', () => {
  let component;
  beforeEach(() => {
    component = shallow(<PageTemplateDeleteModal />);
  });
  ...
  describe('component with required props only', () => {
    ...
    it('has an EmptyStateIcon', () => {
      ...
      expect(emptyStateIcon.hasClass('PageTemplateDeleteModal__icon')).toBe(true);
    });
    ...
    it('has an EmptyStateInfo', () => {
      ...
      expect(emptyStateInfo.hasClass('PageTemplateDeleteModal__info')).toBe(true);
    });
  });

  describe('component with extra props', () => {
    it('renders info prop', () => {
      component = shallow(<PageTemplateDeleteModal {...props} />);
