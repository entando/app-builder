...
describe('DeleteGroupModal', () => {
  let component;
  beforeEach(() => {
    component = shallow(<DeleteGroupModal />);
  });
  ...
  describe('component with required props only', () => {
    ...
    it('has an EmptyStateIcon', () => {
      ...
      expect(emptyStateIcon.hasClass('DeleteGroupModal__icon')).toBe(true);
    });
    ...
    it('has an EmptyStateInfo', () => {
      ...
      expect(emptyStateInfo.hasClass('DeleteGroupModal__info')).toBe(true);
    });
  });

  describe('component with extra props', () => {
    it('renders info prop', () => {
      component = shallow(<DeleteGroupModal {...props} />);
      const title = component.find('EmptyStateTitle');
      expect(title.render().text()).toContain('group');
    });
