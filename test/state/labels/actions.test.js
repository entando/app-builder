...
import {
  ...
  removeLabelSync, removeLabel, fetchLabel, setSearchTerm, setLabelFilters,
} from 'state/labels/actions';
import { SET_LABELS, UPDATE_LABEL, REMOVE_LABEL, SET_SELECTED_LABEL, SET_SEARCH_TERM, SET_LABEL_FILTERS } from 'state/labels/types';
