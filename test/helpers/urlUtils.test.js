...
describe('Verify corectness of mfe routes generation', () => {
  it('should generate correct routes for mfe if id is not available', () => {
    ...
    expect(generateMfeRoutes([mfe])).toEqual([
      { route: '/example-mfe-4-group/example-mfe-4-code/', id: 'id-example-mfe-4-group-example-mfe-4-code-/-example-mfe-4-widget-code' }]);
  });
  ...
  it('should generate correct routes for mfe if id is available', () => {
    ...
    expect(generateMfeRoutes([mfe])).toEqual([
      { route: '/layout-core-bundle/layout-core-bundle-id/route1', id: '1a793414-d773-42ef-922e-00acafa43aa9' },
      { route: '/layout-core-bundle/layout-core-bundle-id/route2', id: '1a793414-d773-42ef-922e-00acafa43aa9' }]);
  });
