...
export const getDEComponent = id => (
  makeRequest({
    uri: `/components/${encodeURIComponent(id)}`,
...
export const postDEComponentInstall = component => (
  makeRequest({
    uri: `/components/install/${encodeURIComponent(component.id)}`,
    domain: '/digital-exchange',
    body: {},
    method: METHODS.POST,
...
export const getDEComponentInstall = id => (
  makeRequest({
    uri: `/components/install/${encodeURIComponent(id)}`,
    domain: '/digital-exchange',
    method: METHODS.GET,
...
export const postDEComponentUninstall = id => (
  makeRequest({
    uri: `/components/uninstall/${encodeURIComponent(id)}`,
    domain: '/digital-exchange',
    body: {},
    method: METHODS.POST,
