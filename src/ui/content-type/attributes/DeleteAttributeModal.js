...
const DeleteAttributeModal = ({ onConfirmDelete, info }) => {
  const buttons = [
    <Button
      bsStyle="danger"
      id="DeleteAttributeModal__button-delete"
  ...
  return (
    <GenericModalContainer
      ...
      className="DeleteAttributeModal"
    >
      <EmptyState>
        <EmptyStateIcon name="exclamation" type="fa" className="DeleteAttributeModal__icon" />
        <EmptyStateTitle>
          <FormattedMessage id="cms.label.delete" />
          &nbsp;{info.type}
        </EmptyStateTitle>
        <EmptyStateInfo className="DeleteAttributeModal__info">
