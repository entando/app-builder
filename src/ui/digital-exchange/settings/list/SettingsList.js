        ...
        <Card>
          <DropdownKebab className="pull-right" pullRight id={`${marketplace.id}-actions`}>
            <LinkMenuItem
              ...
              to={routeConverter(ROUTE_DE_CONFIG_EDIT, { server: marketplace.id })}
          ...
          <CardBody>
            <strong><FormattedMessage id="digitalExchange.settings.active" /></strong>: {activeIcon(marketplace.active)}
            <br />
            <strong><FormattedMessage id="digitalExchange.settings.address" /></strong>: {marketplace.url}
          </CardBody>
        </Card>
      </Col>
    ));
