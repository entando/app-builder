...
class RenderDateTimePickerInput extends Component {
  ...
  render() {
    ...
    const {
      field, name, label, help, locale, dateFormat, placeholder, meta: { touched, error },
    } = this.props;
    return (
          ...
          <Row>
            <Col xs={3}>
              <DatePicker
                ...
                selected={field.value ? moment(field.value, this.props.dateFormat) : null}
