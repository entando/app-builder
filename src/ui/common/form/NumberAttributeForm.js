...
export class DataAttributeNumberFormBody extends Component {
  constructor(props) {
    super(props);
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="DataAttributeNumberForm__required-fields text-right">
...
DataAttributeNumberFormBody.propTypes = {
...
DataAttributeNumberFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
...
const DataAttributeNumberForm = reduxForm({
  form: 'NumberAttribute',
})(DataAttributeNumberFormBody);

export default DataAttributeNumberForm;
