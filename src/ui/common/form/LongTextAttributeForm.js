...
export class DataAttributeLongTextFormBody extends Component {
  constructor(props) {
    super(props);
...
DataAttributeLongTextFormBody.propTypes = {
...
DataAttributeLongTextFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
...
const DataAttributeLongTextForm = reduxForm({
  form: 'LongTextAttribute',
})(DataAttributeLongTextFormBody);

export default DataAttributeLongTextForm;
