...
export class DataAttributeDateFormBody extends Component {
  constructor(props) {
    super(props);
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="DataAttributeDateForm__required-fields text-right">
...
DataAttributeDateFormBody.propTypes = {
...
DataAttributeDateFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
...
const DataAttributeDateForm = reduxForm({
  form: 'DateAttribute',
})(DataAttributeDateFormBody);

export default DataAttributeDateForm;
