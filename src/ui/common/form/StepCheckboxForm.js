...
export class StepCheckboxFormBody extends Component {
  constructor(props) {
    super(props);
     ...
     return (
       <form onSubmit={this.onSubmit} className="form-horizontal">
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="StepCheckboxForm__required-fields text-right">
         ...
         <Row>
           <Col xs={12}>
             <Button
               className="pull-right StepCheckboxForm__add--btn"
               type="submit"
               bsStyle="primary"
...
StepCheckboxFormBody.propTypes = {
...
StepCheckboxFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
  attributeCode: '',
...
const StepCheckboxForm = reduxForm({
  form: 'StepCheckbox',
})(StepCheckboxFormBody);

export default StepCheckboxForm;
