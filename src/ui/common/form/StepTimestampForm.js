...
export class StepTimestampFormBody extends Component {
  constructor(props) {
    super(props);
     ...
     return (
       <form onSubmit={this.onSubmit} className="form-horizontal">
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="StepTimestampForm__required-fields text-right">
         ...
         <Row>
           <Col xs={12}>
             <Button
               className="pull-right StepTimestampForm__add--btn"
               type="submit"
               bsStyle="primary"
...
StepTimestampFormBody.propTypes = {
...
StepTimestampFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
  attributeCode: '',
...
const StepTimestampForm = reduxForm({
  form: 'StepTimestamp',
})(StepTimestampFormBody);

export default StepTimestampForm;
