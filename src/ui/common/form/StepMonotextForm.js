...
export class StepMonotextFormBody extends Component {
  constructor(props) {
    super(props);
     ...
     return (
       <form onSubmit={this.onSubmit} className="form-horizontal">
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="StepMonotextForm__required-fields text-right">
         ...
         <Row>
           <Col xs={12}>
             <Button
               className="pull-right StepMonotextForm__add--btn"
               type="submit"
               bsStyle="primary"
...
StepMonotextFormBody.propTypes = {
...
StepMonotextFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
  attributeCode: '',
...
const StepMonotextForm = reduxForm({
  form: 'StepMonotext',
})(StepMonotextFormBody);

export default StepMonotextForm;
