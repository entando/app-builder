...
export class DataAttributeCompositeFormBody extends Component {
  constructor(props) {
    super(props);
...
DataAttributeCompositeFormBody.propTypes = {
...
DataAttributeCompositeFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
...
const DataAttributeCompositeForm = reduxForm({
  form: 'CompositeAttribute',
})(DataAttributeCompositeFormBody);

export default DataAttributeCompositeForm;
