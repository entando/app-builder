...
export class StepHypertextFormBody extends Component {
  constructor(props) {
    super(props);
     ...
     return (
       <form onSubmit={this.onSubmit} className="form-horizontal">
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="StepHypertextForm__required-fields text-right">
         ...
         <Row>
           <Col xs={12}>
             <Button
               className="pull-right StepHypertextForm__add--btn"
               type="submit"
               bsStyle="primary"
...
StepHypertextFormBody.propTypes = {
...
StepHypertextFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
  attributeCode: '',
...
const StepHypertextForm = reduxForm({
  form: 'StepHypertext',
})(StepHypertextFormBody);

export default StepHypertextForm;
