...
export class StepEnumeratorMapFormBody extends Component {
  constructor(props) {
    super(props);
     ...
     return (
       <form onSubmit={this.onSubmit} className="form-horizontal">
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="StepEnumeratorMapForm__required-fields text-right">
         ...
         <Row>
           <Col xs={12}>
             <Button
               className="pull-right StepEnumeratorMapForm__add--btn"
               type="submit"
               bsStyle="primary"
...
StepEnumeratorMapFormBody.propTypes = {
...
StepEnumeratorMapFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
  attributeCode: '',
...
const StepEnumeratorMapForm = reduxForm({
  form: 'StepEnumeratorMap',
})(StepEnumeratorMapFormBody);

export default StepEnumeratorMapForm;
