...
export class DataAttributeTextFormBody extends Component {
  constructor(props) {
    super(props);
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="DataAttributeTextForm__required-fields text-right">
...
DataAttributeTextFormBody.propTypes = {
...
DataAttributeTextFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
...
const DataAttributeTextForm = reduxForm({
  form: 'TextAttribute',
})(DataAttributeTextFormBody);

export default DataAttributeTextForm;
