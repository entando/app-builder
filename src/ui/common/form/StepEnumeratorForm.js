...
export class StepEnumeratorFormBody extends Component {
  constructor(props) {
    super(props);
     ...
     return (
       <form onSubmit={this.onSubmit} className="form-horizontal">
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="StepEnumeratorForm__required-fields text-right">
         ...
         <Row>
           <Col xs={12}>
             <Button
               className="pull-right StepEnumeratorForm__add--btn"
               type="submit"
               bsStyle="primary"
...
StepEnumeratorFormBody.propTypes = {
...
StepEnumeratorFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
  attributeCode: '',
...
const StepEnumeratorForm = reduxForm({
  form: 'StepEnumerator',
})(StepEnumeratorFormBody);

export default StepEnumeratorForm;
