...
export class StepNumberFormBody extends Component {
  constructor(props) {
    super(props);
     ...
     return (
       <form onSubmit={this.onSubmit} className="form-horizontal">
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="StepNumberForm__required-fields text-right">
         ...
         <Row>
           <Col xs={12}>
             <Button
               className="pull-right StepNumberForm__add--btn"
               type="submit"
               bsStyle="primary"
...
StepNumberFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
  attributeCode: '',
...
const StepNumberForm = reduxForm({
  form: 'StepNumber',
})(StepNumberFormBody);

export default StepNumberForm;
