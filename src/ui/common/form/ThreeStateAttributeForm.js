...
export class ThreeStateAttributeFormBody extends Component {
  constructor(props) {
    super(props);
           ...
           <Col xs={12}>
             <fieldset className="no-padding">
               <legend>
                 ...
                 <div className="ThreeStateAttributeForm__required-fields text-right">
...
ThreeStateAttributeFormBody.propTypes = {
...
ThreeStateAttributeFormBody.defaultProps = {
  onWillMount: () => {},
  invalid: false,
  submitting: false,
...
const ThreeStateAttributeForm = reduxForm({
  form: 'ThreeStateAttribute',
})(ThreeStateAttributeFormBody);

export default ThreeStateAttributeForm;
