...
const msgs = defineMessages({
  ...
  urlPlaceholder: {
    id: 'componentRepository.settings.form.url.placeholder',
    defaultMessage: 'URL',
  },
  clientId: {
    id: 'componentRepository.settings.form.clientId',
    defaultMessage: 'Client ID',
  },
  clientSecret: {
    id: 'componentRepository.settings.form.clientSecret',
      ...
      <form onSubmit={handleSubmit} className="form-horizontal">
        <Row>
          <Col xs={12}>
            <fieldset className="no-padding">
              <legend>
                <FormattedMessage id="componentRepository.settings.generalSettings" />
        ...
        <Row>
          <Col xs={12}>
            <Field
              ...
              name="url"
              label={
                <FormLabel labelId="componentRepository.settings.form.url" required />
              }
        ...
        <Row>
          <Col xs={12}>
            <Field
              ...
              name="clientId"
              label={
                <FormLabel labelId="componentRepository.settings.form.clientId" />
              }
        ...
        <Row>
          <Col xs={12}>
            <Field
              ...
              name="clientSecret"
              label={
                <FormLabel labelId="componentRepository.settings.form.clientSecret" />
              }
        ...
        <Row>
          <Col xs={12}>
            <Field
              ...
              name="timeout"
              label={
                <FormLabel labelId="componentRepository.settings.form.timeout" required />
              }
        ...
        <Row>
          <Col xs={2} className="text-right">
            <ControlLabel>
              <FormLabel labelId="componentRepository.settings.form.active" />
            </ControlLabel>
          </Col>
          <Col xs={10}>
            <Field
