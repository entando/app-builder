export default {
  ...
  messages: {
    ...
    'widgets.configUi': 'Config UI (Microfrontend)',
    ...
    'tour.step.2.title': 'To create your first application you start creating the home page, your first page',
    'tour.step.2.description': 'get familiar with the menu',
    'tour.step.cancel.title': 'Are you sure you want to exit the tutorial?',
    'app.next': 'Next',
    'tour.step.3.title': 'Point to Menu Pages',
    'tour.step.3.description': 'Click on Menu Pages',
    'tour.step.4.title': 'Point to Menu Management',
    'tour.step.4.description': 'Click on Menu Management',
    'tour.step.5.title': 'Create a Page',
    'tour.step.5.description': 'Click on Add Button to create a new page',
    'tour.step.6.title': 'Choose a title for your page',
    'tour.step.6.description': 'Choose a Title for your page',
    'tour.step.7.title': 'Choose the code',
    'tour.step.7.description': 'Choose the code',
    ...
    'tour.step.11.title': 'Now you can save and configure your first page',
    'tour.step.11.description': 'Save and Configure your page',
    'tour.step.12.title': 'Now you can choose the widgets for your page',
    'tour.step.12.description': 'Drag & Drop the following widget: Custom - Logo',
    'tour.step.13.title': 'Now you can choose the widgets for your page',
    'tour.step.13.description': 'Drag & Drop the following widget: Custom - Navigation Menu',
    'tour.step.14.title': 'Choose the navigation starting point',
    'tour.step.14.description': 'Click on "Specific" and choose any page to show in the navigation bar',
    'tour.step.15.title': 'Click Add a new expression',
    'tour.step.15.description': 'This will add a new expression to navigation menu',
    'tour.step.16.title': 'Save the navigation menu configuration',
    'tour.step.16.description': 'Save the configuration and return to the page configuration screen',
    'tour.step.17.title': 'Now you can choose the widgets for your page',
    'tour.step.17.description': 'Drag & Drop the following widget: CMS - Content',
    'tour.step.18.title': 'Click on Add existing content',
    'tour.step.18.description': 'Click on Add existing content button to browse available published contents',
    'tour.step.19.title': 'Select a published content',
    'tour.step.19.description': 'Select a published content to assign it to use it for the Content configuration',
    'tour.step.20.title': 'Click Choose',
    'tour.step.20.description': 'Click Choose to finish assignment',
    'tour.step.21.title': 'Click Save',
    'tour.step.21.description': 'Click to save the content widget configuration',
    'tour.step.22.title': 'Save & Publish your first page',
    'tour.step.22.description': 'Click on Publish Button to save and publish your first page',
