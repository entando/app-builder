export default {
  ...
  messages: {
    ...
    'fragment.page.help': 'The FRAGMENTS section lets you manage existing fragments or add new fragments. The fragments are single portions of front-end interface used in Widgets (including plugins) and Page Models.',
