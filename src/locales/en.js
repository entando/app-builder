export default {
  ...
  messages: {
    ...
    'app.timestamp.hours': 'Pick an hour',
    'app.timestamp.minutes': 'Pick a minute',
    'app.timestamp.seconds': 'Pick a second',
    ...
    'fragment.help': 'The UX FRAGMENTS section lets you manage existing UX Fragments or add new UX Fragments. The UX Fragments are single portions of front-end interface used in Widgets (including plugins) and Page Templates.',
    'fragment.code': 'Code',
    ...
    'pageSettings.baseUrl.help': 'The URLs are produced from the BASE URL defined in the context file (es.: www.entando.com/ site/ en/ pagecode.page). RELATIVE when in the generated caused URL omitted the BASE URL (es.: /site /en / pagecode.page). BUILT BY HTTP REQUEST PARAMETERS when the URL generated from the request takes the parameter generated from the previews request. STATIC when in the generated URL is insert the BASE URL defined in the context file ( es.: www.entando.com/ site/ en/ pagecode.page)',
    'pageSettings.jsession.help': 'It is a security requisite. Avoid that the JSESSIONID would insert in the generated link from the site. You must have cookies activted.',
    ...
    'pageTemplates.help': 'The PAGE TEMPLATES section lets you manage existing page templates or add new. The Page Template defines the page structure. A page template is characterized by two elements: scheme (the division of the page in smaller area called frames) and decoration (the look and feel of the page). Within an Entando application you can configure multiple page templates.',
    'pageTemplates.name.help': 'You can insert max 50 uppercase and lowercase letters, numbers and special characters.',
    'pageTemplates.code.help': 'You can insert max 40 characters uppercase and lowercase letters, numbers and special characters.',
    ...
    'componentRepository.disabled.help': 'It can be enabled by setting COMPONENT_REPOSITORY_UI_ENABLED env variable value in your .env file to true.',
    'componentRepository.menuButton.title': 'ECR',
    'componentRepository.component.list.title': 'Entando Component Repository',
    'componentRepository.component.help': 'Entando Component Repository is a marketplace from which users can install different Widgets, Components, Fragments, Page Templates, Content Templates and Content Types.',
    ...
    'componentRepository.components.notifyInProgress': 'Installation unexpectedly still in progress. You can check again by refreshing the page.',
    ...
    'plugins.noPlugins': 'No installed plugins. See available plugins on the Component Repository',
