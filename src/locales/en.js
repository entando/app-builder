export default {
  ...
  messages: {
    ...
    'tour.step.14.description': 'On the right sidebar, expand the CMS menu. Then drag & drop the Logo widget into the dotted grey \'Search Form\' section on the page.',
    'tour.step.15.title': 'Add Widgets',
    'tour.step.15.description': 'On the right sidebar, expand the System menu. Then drag & drop the Logo widget into the dotted grey \'Login\' section on the page.',
