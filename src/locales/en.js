export default {
  ...
  messages: {
    ...
    'fileBrowser.createFolderSuccess': 'Folder created successfully',
    'fileBrowser.createFolderError': 'An error occurred creating the folder',
    'fileBrowser.deleteFolderSuccess': 'Folder \'{path}\' deleted successfully',
    'fileBrowser.deleteFolderError': 'An error occurred deleting the folder \'{path}\'',
