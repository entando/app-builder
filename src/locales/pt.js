export default {
  ...
  messages: {
    ...
    'app.title': 'Título',
    'app.alert.notAvaible': 'Indisponível',
    'app.info': 'Informação',
    'app.name': 'Nome',
    'app.group': 'Grupo',
    'app.code': 'Código',
    ...
    'app.add.attribute.code': 'Você deve insireir 3 caracteres maiúsculos',
    ...
    'app.ognl.validation.help3': 'Você pode o mapa de linguagem do sistema (#langs) e a entidade associada (#entity).',
    ...
    'app.deleted': 'O {type} {code} foi deletado',
    ...
    'menu.pageModels': 'Modelos de Página',
    'menu.pageModelDetails': 'Detalhes do Modelo de Página',
    ...
    'menu.widget': 'Widget',
    'menu.labelsAndLanguages': 'Labels e Idiomas',
    'menu.uxPattern.addLabels': 'Rótulos de sistema',
    ...
    'pageTreePage.help': 'A seção ÁRVORES DE PÁGINAS permite você gerenciar uma página existente, mostrar ou esconder todas as páginas existentes na árvore ou mostrar todas/esconder todas que pertencem ao nó principal. Você pode também adicionar ou mover uma página, dentre outras ações: preview mobile ou desktop, configurar, editar, ver detalhes, clonar umá página ou deletar. Além disso você pode visualizar o estado (rascunho ou online) se a página estiver na lista de menu.',
    'pageDetails.title': 'Detalhes de Página',
    'pageDetails.help': 'A seção ÁRVORES DE PÁGINAS permite você gerenciar uma página existente, mostrar ou esconder todas as páginas existentes na árvore ou mostrar todas/esconder todas que pertencem ao nó principal. Você pode também adicionar ou mover uma página, dentre outras ações: preview mobile ou desktop, configurar, editar, ver detalhes, clonar umá página ou deletar. Além disso você pode visualizar o estado (rascunho ou online) se a página estiver na lista de menu.',
    ...
    'validateForm.element': 'Insira uma configuração no formato \'lable1,lable2,lable3\'',
    ...
    'validateForm.widgetCode': '{name} contém caracteres inválidos. Somente caracteres alfanumpericos e sublinhado _ são permitidos',
    'validateForm.passwordNotMatch': 'Confirm value doesn\'t match with Password value',
    'validateForm.code': 'Código contém caracteres inválidos. omente caracteres alfanumpericos e sublinhado \'_\' são permitidos.',
    ...
    'fragment.alert.error.fileExtension': 'Essa extenção não é permitida',
    ...
    'fileBrowser.deleteFolderSuccess': 'Pasta \'{path}\' deletada com sucesso',
    'fileBrowser.deleteFolderError': 'Ocorreu um erro ao deletar a pasta \'{path}\'',
    'fileBrowser.deleteFileSuccess': 'Arquivo \'{path}\' deletado com sucesso',
    'fileBrowser.deleteFileError': 'Ocorreu um erro ao deletar o arquivo \'{path}\'',
    ...
    'pages.pageForm.pageModel': 'Modelo de Página',
    'pages.pageForm.pageModelHelp': 'Selecionar um Modelo de Página',
    ...
    'pageSettings.input.baseURL.http': 'Contruído por parâmetros HTTP',
    'pageSettings.input.baseURL.relative': 'Relativo',
    'pageSettings.input.baseURL.static': 'Estático',
    'pageSettings.input.appendBaseURL': 'Concaternar nome de contexto à URL base',
    ...
    'pageSettings.input.pageTreeStyle': 'Escolha o estílo da Árvore de Páginas',
    ...
    'dataModel.deleteDataModelSuccess': 'Modelo de Dados \'{id}\' deletado com sucesso',
    'dataModel.deleteDataModelError': 'Ocorreu um erro ao deletar o Modelo de Dados \'{id}\'',
    ...
    'modal.confirm.delete': 'Você deseja realmente deletar o código {code}?',
    ...
    'reloadConfiguration.confirm.error': 'Ocorreu algo de errado enquanto recarregavamos a configuração. Tente novamente em alguns minutos.',
    'activityStream.newPage': 'criou uma nova página',
    'activityStream.editPage': 'editou uma nova página',
    'activityStream.deletePage': 'deletou uma página',
    ...
    'digitalExchange.component.help': 'Entando Digital Exchange é um marketplace onde usuário podem instalar diferentes Widgets, Componentes, Fragmentos, Modelos de Página, Modelos de Conteúdo e Tipos de Conteúdo.',
    ...
    'digitalExchange.components.failedUninstall': 'Falha ao desisntalar',
    ...
    'digitalExchange.categories.widget': 'Widgets',
    'digitalExchange.categories.pageModel': 'Modelos de Página',
    'digitalExchange.categories.component': 'Componentes',
    'digitalExchange.categories.fragment': 'Fragmentos',
    'digitalExchange.categories.api': 'API',
    'digitalExchange.categories.contentModel': 'Modelos de Conteúdo',
    'digitalExchange.categories.contentType': 'Tipos de Conteúdo',
    'digitalExchange.extraFilters.explore': 'Explorar',
    'digitalExchange.extraFilters.popular': 'Populares',
    ...
    'digitalExchange.settings.generalSettings': 'Configurações gerais',
    'digitalExchange.settings.form.url': 'URL',
    'digitalExchange.settings.form.url.placeholder': 'http://dominio.com.br/de',
    'digitalExchange.settings.form.key': 'Chave',
    'digitalExchange.settings.form.secret': 'Senha',
    'digitalExchange.settings.form.timeout': 'Timeout',
    'digitalExchange.settings.form.active': 'Ativo',
