export default {
  ...
  messages: {
    ...
    'menu.pageDesigner': 'Gerenciamento de Página',
    'menu.pageTree': 'Páginas',
    'menu.uxComponents': 'Componentes UX',
    ...
    'menu.userSettings': 'Configurações do Usuário',
    'menu.widgetEdit': 'Editar Widget',
    'menu.fragments': 'UX Fragment',
    'menu.pageTemplates': 'Modelos de Página',
    ...
    'menu.users.restrictions': 'Restrições de Usuário',
    'menu.cms': 'Gerenciamento de conteúdo',
    ...
    'menu.labelsAndLanguages': 'Rótulos e Idiomas',
