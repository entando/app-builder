export default {
  ...
  messages: {
    ...
    'widget.page.config.loading': 'Carregando micro frontend...',
    ...
    'widget.icon.description': 'Carregue o seu ícone da Biblioteca de ícones ou do seu computador',
    ...
    'user.myProfile.uploadImage': 'Carregar seu perfil de imagem',
    'user.myProfile.uploadRestriction': 'Apenas imagem (JPG, PNG) max {maxSize}',
    ...
    'componentRepository.components.downgradeMessage': 'Esteja ciente de que fazer o downgrade de um pacote para uma versão anterior pode resultar em perda de recursos ou dados. Você pode querer revisar as notas de lançamento do pacote antes de fazer um downgrade.',
    'componentRepository.components.downgrade': 'Downgrade',
    'componentRepository.components.conflict': 'Conflito',
    'componentRepository.components.conflictMessage': 'Não foi possível determinar se esta operação poderia implicar em um downgrade. Esteja ciente de que instalar uma versão mais antiga pode resultar em perda de recursos ou dados. Você pode querer revisar as notas de lançamento do pacote antes de continuar.',
    'componentRepository.components.replace': 'Substituir',
    'componentRepository.components.proceed': 'Você quer prosseguir?',
    ...
    'componentRepository.categories.contentTemplate': 'Modelos de Conteúdo',
    ...
    'componentRepository.installationPlan': 'Plano de instalação',
    'componentRepository.activeFilters': 'Filtros ativos',
    'componentRepository.filterAll': 'Todos',
    'componentRepository.filterConflicts': 'Conflitos',
    'componentRepository.updateAll': 'Atualizar tudo',
    'componentRepository.skipAll': 'Ignorar tudo',
    'componentRepository.componentName': 'Nome do componente',
    'componentRepository.category': 'Categoria',
    'componentRepository.status': 'Status',
    'componentRepository.actions': 'Ações',
    'componentRepository.install': 'Instalar',
    'componentRepository.skip': 'Pular',
    'componentRepository.update': 'Atualizar',
    ...
    'user.myProfile.defaultPageOwnerGroup': 'Grupo de proprietários de página padrão',
    'user.myProfile.defaultPageOwnerGroupHelp': 'Define o grupo de proprietários padrão ao criar uma página.',
    'user.myProfile.defaultPageJoinGroups': 'Página padrão para participar de grupos',
    'user.myProfile.defaultPageJoinGroupsHelp': 'Define os grupos de associação padrão ao criar uma página.',
    'user.myProfile.defaultContentOwnerGroup': 'Grupo de proprietário de conteúdo padrão',
    'user.myProfile.defaultContentOwnerGroupHelp': 'Define o grupo de proprietários padrão ao criar um conteúdo.',
    'user.myProfile.defaultContentJoinGroups': 'Grupos de associação de conteúdo padrão',
    'user.myProfile.defaultContentJoinGroupsHelp': 'Define os grupos de associação padrão ao criar um conteúdo.',
    'user.myProfile.defaultWidgetOwnerGroup': 'Grupo de proprietário de widget padrão',
    'user.myProfile.defaultWidgetOwnerGroupHelp': 'Define o grupo de proprietários padrão ao criar um widget ou MFE.',
    ...
    'emailConfig.smtpServer.connection': 'Conexão',
    'emailConfig.smtpServer.host': 'Host',
    'emailConfig.smtpServer.port': 'Port',
    'emailConfig.smtpServer.security': 'Security',
    'emailConfig.smtpServer.checkServerIdentity': 'Verifique a identidade do servidor',
    'emailConfig.smtpServer.timeout': 'Tempo limite (em milissegundos)',
    'emailConfig.smtpServer.authentication': 'Autenticação',
    ...
    'emailConfig.saveSuccessful': 'Configuração de e-mail salva com sucesso.',
    ...
    'validateForm.friendlyCode': 'O Friendly Code deve ter letras minúsculas, incluindo números ou o caractere especial \'_\'.',
    'validateForm.friendlyCodeUnique': 'O Friendly Code deve ser exclusivo para todos os idiomas.',
    ...
    'pageTree.searchForm.search.code': 'Pesquisa por Código',
    'rte.undoWithExample': 'Desfazer (Ctrl + Z)',
    'rte.redoWithExample': 'Refazer (Ctrl + Y)',
    'rte.insertTable': 'Insira a Tabela',
    'rte.insertTableRow': 'Inserir Linha da Tabela',
    'rte.insertTableColumn': 'Inserir Coluna da Tabela',
    'rte.deleteTableColumn': 'Excluir Coluna da Tabela',
    'rte.deleteTableRow': 'Excluir Linha da Tabela',
    'rte.deleteTable': 'Apagar Tabela',
    'rte.insertHorizontalLine': 'Inserir Linha Horizontal',
    'rte.insertSpecialChar': 'Inserir Caractere Especial',
    'rte.maximize': 'Maximizar',
    'rte.boldWithExample': 'Bold (Ctrl + B)',
    'rte.italicWithExample': 'Italic (Ctrl + I)',
    'rte.strikethrough': 'Tachado',
    'rte.removeFormat': 'Remover Formato',
    'rte.toggleNumberList': 'Inserir/Remover Lista Numerada',
    'rte.toggleBulletedList': 'Inserir/Remover Lista Com Marcadores',
    'rte.decreaseIndent': 'Recuar Devagar',
    'rte.increaseIndent': 'Aumentar Recuo',
    'rte.blockQuote': 'Bloco de Citação',
    'rte.link': 'Link',
    'rte.unlink': 'Unlink',
    'rte.source': 'Fonte',
    ...
    'hub.newRegistry': 'Novo Registro',
    'hub.selectRegistry': 'Selecione o Registro',
    'hub.localRegistry.title': 'Registro Local',
    'hub.localRegistry.description': 'Este é um registro local onde todos os seus pacotes implantados estão aparecendo, bem como os componentes ECR',
    ...
    'app.undeployed': 'Desempregado',
    'hub.bundle.status': 'Status',
    'hub.bundle.refresh': 'Atualizar',
    'hub.bundle.NOT_FOUND': 'NÃO DEPREGADOS',
    'hub.bundle.INSTALLED': 'INSTALADO',
    'hub.bundle.UNDEPLOYED': 'NÃO DEPREGADOS',
    'hub.bundle.DEPLOYED': 'IMPLANTADO',
    'hub.bundle.INSTALLED_NOT_DEPLOYED': 'INSTALADO NÃO INSTALADO',
    'hub.bundle.INVALID_REPO_URL': 'INVALID_REPO_URL',
    'componentRepository.categories.language': 'Língua',
    'componentRepository.categories.label': 'Rótulo',
    'componentRepository.categories.content': 'Contente',
    'componentRepository.categories.page': 'Página',
    'componentRepository.categories.asset': 'De ativos',
