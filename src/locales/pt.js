export default {
  ...
  messages: {
    ...
    'tour.step.17.description': 'Trascina e rilascia il seguente widget: Entando CMS -> Content',
    ...
    'tour.step.22.description': 'Salva le impostazioni e pubblica la tua pagina',
