export default {
  ...
  messages: {
    ...
    'user.authority.added': 'Nova autorização ({groupname}, {rolename}) foi adicionada',
    'user.authority.success': 'A autorização foi atualizada',
    ...
    'componentRepository.component.help': 'Entando Hub é um marketplace onde os usuários podem instalar diferentes Widget, Componentes, UX Fragment, Modelos de Página, Modelos de Conteúdo e Tipos de Conteúdo.',
    ...
    'componentRepository.settings.help': 'Nessa seção é possível configurar e gerenciar as configurações do marktplace Entando Hub.',
    ...
    'hub.localRegistry.title': 'Hub Local',
    ...
    'contextSelect.GOTO_CONTEXT': 'Ir à...',
  },
};
