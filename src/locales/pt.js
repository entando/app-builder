export default {
  ...
  messages: {
    ...
    'user.myProfile.defaultOwnerGroup': 'Grupo de proprietários padrão',
    'user.myProfile.defaultOwnerGroupHelp': 'Define o grupo de proprietários padrão ao criar uma página ou conteúdo.',
    'user.myProfile.defaultJoinGroups': 'Default Join Groups',
    'user.myProfile.defaultJoinGroupsHelp': 'Define os grupos de associação padrão ao criar uma página ou conteúdo.',
