export default {
  ...
  messages: {
    ...
    'user.myProfile.defaultWidgetJoinGroups': 'Grupos de adesão de widget padrão',
    'user.myProfile.defaultWidgetJoinGroupsHelp': 'Define os grupos de associação padrão ao criar um widget ou MFE.',
