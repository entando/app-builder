export default {
  ...
  messages: {
    ...
    'widget.page.config.goToConfig': 'Vai alla configurazione',
    'widget.page.config.readOnlyMessage': 'Questo widget è in modalità di sola lettura, è necessario modificarlo nella configurazione del widget.',
