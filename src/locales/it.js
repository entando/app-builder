export default {
  ...
  messages: {
    ...
    'contentPicker.searchPlaceholder': 'inizia a digitare per cercare un contenuto',
    ...
    'validateForm.widgetCode':
      '{name} contiene caratteri non consentiti. Usare solo caratteri alfanumerici o underscore _',
    'validateForm.passwordNotMatch':
      'Il valore di Conferma non coincide col valore della Password',
    'validateForm.code':
      "Codice contiene caratteri non validi. Usare solo caratteri alfanumerici o l'underscore '_'.",
    ...
    'widget.form.contentModel': 'Modello di contenuto',
    ...
    'widget.help':
      "Dalla sezione WIDGET puoi gestire i widget esistenti o crearne di nuovi. I widget sono oggetti utilizzati per visualizzare informazioni e funzionalitá o servizi sulle pagine di un'applicazione.",
    'fragment.list.title': 'Frammenti',
    'fragment.help':
      'Dalla sezione FRAGMENT puoi gestire i fragments esistenti o crearne di nuovi. I fragments sono singole porzioni di interfaccia di front-end utilizzati nei Widget (anche quelli dei plugin) e nei Modelli di Pagina.',
    ...
    'fragment.detail.emptyReferenceFragments':
      'Non ci sono fragments associati',
    'fragment.detail.emptyReferencePageModels':
      'Non ci sono modelli di pagine associati',
    ...
    'fragment.settings':
      'Abilita la creazione di fragment con default GUI vuota',
    ...
    'fileBrowser.help':
      'La sezione FILE BROWSER permette di navigare le cartelle del file system.',
    ...
    'ProfileType.created': 'PROFILE TYPE creato con successo',
    ...
    'user.username.help':
      "Inserire tra 4 e 20 caratteri, lettere maiuscole e minuscole, numeri '.' e  '_'.",
    'user.password.help':
      "Inserire tra 8 e 20 caratteri, lettere maiuscole e minuscole, numeri '.' e  '_'.",
    'user.validate.text':
      "Contiene caratteri non consentiti. Usare solo caratteri alfanumerici, il punto '.' o l'underscore '_'.",
    ...
    'group.help':
      "Dalla sezione GRUPPI l'amministratore può gestire i gruppi esistenti o crearne di nuovi. I Gruppi servono a definire dei sottoinsiemi di oggetti e ad autorizzare sottoinsiemi di utenti ad operare su di essi.",
    ...
    'DataType.type': 'Type',
    'role.help':
      "Dalla sezione RUOLI l'amministratore crea e gestisce i ruoli degli utenti. I ruoli sono un insieme configurabile di permessi che definiscono le azioni che l'utente può compiere all'interno del portale.",
    ...
    'digitalExchange.disabled.help':
      'È possibile attivarla impostando DIGITAL_EXCHANGE_UI_ENABLED=true nel file .env',
    ...
    'digitalExchange.component.help':
      "Entando Digital Exchange è un marketplace da cui l'utente può installare Widget, Componenti, Frammenti, Modelli di Pagina, Modeli di Contenuto e Tipi di Contenuto",
    ...
    'digitalExchange.components.failedUninstall': 'Disinstalla Fallita',
    ...
    'digitalExchange.categories.pageModel': 'Modelli di Pagina',
    ...
    'digitalExchange.extraFilters.explore': 'Explore',
    'digitalExchange.extraFilters.popular': 'Popular',
    'digitalExchange.extraFilters.new': 'New',
    'digitalExchange.extraFilters.installed': 'Installed',
    'digitalExchange.settings.title': 'Digital Exchange Configurazione',
    'digitalExchange.settings.help':
      "In questa sezione è possibile aggiungere o gestire le configurazioni di diversi marketplace all'interno del Digital Exchange di Entando.",
    'digitalExchange.settings.add': 'Aggiungi Digital Exchange',
    ...
    'cms.disabled.help':
      'È possibile attivarla impostando CMS_UI_ENABLED=true nel file .env',
    ...
    'plugins.noPlugins':
      'Nessun plugin installato. Guarda i plugin disponibili sulla Digital Exchange',
    'plugins.installCallToAction': 'Vai alla Digital Exchange',
  },
};
