export default {
  ...
  messages: {
    ...
    'digitalExchange.settings.help': 'In questa sezione è possibile aggiungere o gestire le configurazioni di diversi marketplace all\'interno del Digital Exchange di Entando.',
    ...
    'plugins.noPlugins': 'Nessun plugin installato. Guarda i plugin disponibili sulla Digital Exchange',
