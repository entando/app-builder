export default {
  ...
  messages: {
    ...
    'menu.users.restrictions': 'Configurazione Utenti',
    ...
    'user.restrictions.title': 'Configurazione Utenti',
    'user.restrictions.help': 'Dalla sezione CONFIGURAZIONE UTENTI l\'amministratore può attivare un sistema di scadenza delle utenze.',
