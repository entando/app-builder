export default {
  ...
  messages: {
    ...
    'app.ognl.validation.help': 'In questa sezione puoi inserire le validazioni sull\'Attributo.<br> L\'Espressione OGNL deve restituire un valore Boolean (true o false). Nella costruzione delle espressioni, l\'oggetto \'root\' è l\'attributo stesso (si può accedere ai metodi dell\'attributo senza specificarlo o tramite il prefisso #attribute).<br>Sono disponibili: la mappa delle lingue del sistema (#langs) e l\'Entità a cui è associato (#entity).<br>Inoltre per gli elementi di una Lista o di un Composito è possibile accedere al padre dell\'attributo (#parent) e per gli elementi di una Lista si ha a disposizione l\'indice (#index).',
    ...
    'label.searchForm.text': 'Cerca per testo',
