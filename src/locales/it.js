export default {
  ...
  messages: {
    ...
    'widget.list.section.user': 'I miei widget',
    ...
    'pages.pageForm.pageTemplateHelp': 'Seleziona un page template per la pagina',
    'pages.pageForm.findTemplate': 'Trova Template',
