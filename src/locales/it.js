export default {
  ...
  messages: {
    ...
    'reference.status': 'Stato delle referenze',
    'reference.text': 'Le referenze per i seguenti Tipi di Entita\' hanno bisogno di essere ricaricate',
    'reference.status.ready': 'A posto.',
    'reference.status.refreshing': 'Ricaricamento in corso. Aggiorna la pagina.',
    'reference.status.toRefresh': ' Necessita\' di un ricaricamento: lancialo ora.',
  },
};
