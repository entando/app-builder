export default {
  ...
  messages: {
    ...
    'user.myProfile.defaultOwnerGroup': 'Gruppo proprietario predefinito',
    'user.myProfile.defaultOwnerGroupHelp': 'Imposta il gruppo proprietario predefinito durante la creazione di una pagina o di un contenuto.',
    'user.myProfile.defaultJoinGroups': 'Default Join Groups',
    'user.myProfile.defaultJoinGroupsHelp': 'Imposta i gruppi di partecipazione predefiniti durante la creazione di una pagina o di un contenuto.',
