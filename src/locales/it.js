export default {
  ...
  messages: {
    ...
    'menu.pageModels': 'Template di Pagina',
    'menu.pageModelDetails': 'Dettaglio page template',
    ...
    'widget.list.section.user': 'I miei widgets',
    ...
    'fragment.help': 'Dalla sezione FRAGMENT puoi gestire i fragments esistenti o crearne di nuovi. I fragments sono singole porzioni di interfaccia di front-end utilizzati nei Widget (anche quelli dei plugin) e nei Template di Pagina.',
    ...
    'pages.pageForm.pageModel': 'Template di Pagina',
    'pages.pageForm.pageModelHelp': 'Seleziona un page template per la pagina',
    ...
    'pageModels.help': 'Dalla sezione PAGE TEMPLATE puoi gestire i page template esistenti o crearne di nuovi. Il page template definisce la struttura della pagina. All\' interno di un portale Entando si possono configurare piú page template. Il page template determina due aspetti: schema (suddivisione della pagina in zone) e decorazione (aspetto grafico della pagina).',
    ...
    'digitalExchange.disabled.title': 'Component Repository è disabilitata.',
    'digitalExchange.disabled.help': 'È possibile attivarla impostando DIGITAL_EXCHANGE_UI_ENABLED=true nel file .env',
    'digitalExchange.menuButton.title': 'Component Repository',
    'digitalExchange.component.list.title': 'Component Repository',
    'digitalExchange.component.help': 'Entando Component Repository è un marketplace da cui l\'utente può installare Widget, Componenti, Frammenti, Template di Pagina, Modeli di Contenuto e Tipi di Contenuto',
    ...
    'digitalExchange.components.failedUninstall': 'Disinstallazione non riuscita',
    'digitalExchange.components.recheck': 'Ricontrollare',
    'digitalExchange.components.retry': 'Riprovare',
    'digitalExchange.components.inprogress': 'In Corso',
    'digitalExchange.components.notifyInProgress': 'Installazione inaspettatamente ancora in corso. Puoi controllare di nuovo aggiornando la pagina.',
    ...
    'digitalExchange.components.cannotUninstall': 'Impossibile disinstallare',
    'digitalExchange.components.usage': 'Utilizzo dei componenti: {usage}',
    ...
    'digitalExchange.categories.widget': 'Widget',
    'digitalExchange.categories.pageModel': 'Template di Pagina',
    'digitalExchange.categories.component': 'Componenti',
    'digitalExchange.categories.fragment': 'Frammenti',
    'digitalExchange.categories.api': 'API',
    'digitalExchange.categories.plugin': 'Plugins',
    'digitalExchange.categories.contentModel': 'Modelli di Contenuto',
    'digitalExchange.categories.contentType': 'Tipi di Contenuto',
    'digitalExchange.extraFilters.explore': 'Esplora',
    'digitalExchange.extraFilters.popular': 'Popolari',
    'digitalExchange.extraFilters.new': 'Nuovi',
    'digitalExchange.extraFilters.installed': 'Installati',
    'digitalExchange.settings.title': 'Configurazione Component Repository',
    'digitalExchange.settings.help': 'In questa sezione è possibile aggiungere o gestire le configurazioni di diversi marketplace all\'interno del Component Repository di Entando.',
    'digitalExchange.settings.add': 'Aggiungi Component Repository',
    'digitalExchange.settings.active': 'Attivo',
    'digitalExchange.settings.address': 'Indirizzo',
    'digitalExchange.settings.generalSettings': 'Impostazioni Generali',
    'digitalExchange.settings.form.url': 'URL',
    'digitalExchange.settings.form.url.placeholder': 'http://domain.com/de',
    'digitalExchange.settings.form.clientId': 'Client Id',
    'digitalExchange.settings.form.clientSecret': 'Client Secret',
    'digitalExchange.settings.form.timeout': 'Timeout',
    'digitalExchange.settings.form.active': 'Attivo',
    'digitalExchange.filterTabs.all': 'Tutti',
    'digitalExchange.filterTabs.widget': 'Widgets',
    'digitalExchange.filterTabs.pageModel': 'Modello di pagina',
    'digitalExchange.filterTabs.fragment': 'Fragments',
    'digitalExchange.filterTabs.api': 'Plugins',
    'digitalExchange.filterTabs.contentModel': 'Modelli di contenuto',
    'digitalExchange.filterTabs.contentType': 'Tipi di contenuto',
    'digitalExchange.filterTabs.page': 'Pages',
    'digitalExchange.filterTabs.plugin': 'Plugins',
    ...
    'plugins.noPlugins': 'Nessun plugin installato. Guarda i plugin disponibili sulla Component Repository',
    'plugins.installCallToAction': 'Vai alla Component Repository',
