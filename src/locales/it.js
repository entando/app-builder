export default {
  ...
  messages: {
    ...
    'pages.pageForm.seoFriendlyCode': 'Codice Amichevole',
    ...
    'pageTemplates.help': 'Dalla sezione PAGE TEMPLATE puoi gestire i page template esistenti o crearne di nuovi. Il page template definisce la struttura della pagina. All\' interno di un portale Entando si possono configurare piú page template. Il page template determina due aspetti: schema (suddivisione della pagina in zone) e decorazione (aspetto grafico della pagina).',
    ...
    'componentRepository.component.help': 'Entando Component Repository è un marketplace da cui l\'utente può installare Widget, Componenti, Frammenti, Template di Pagina, Modeli di Contenuto e Tipi di Contenuto',
    ...
    'componentRepository.components.recheck': 'Ricontrollare',
    'componentRepository.components.retry': 'Riprovare',
    ...
    'app.seo.description': 'Descrizione di SEO',
    'app.seo.keywords': 'Parole chiave di SEO',
    'app.seo.addMetatag': 'Aggiungi Metatag',
    'app.seo.addMetatagKey': 'Chiave',
    'app.seo.addMetatagValue': 'Valore',
    'app.pages.titleHelp': 'Questo funge da titolo della tua pagina per scopi SEO',
    ...
    'app.seo.inheritLangLabel': 'Eredita dalla lingua predefinita',
  },
};
