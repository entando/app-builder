export default {
  ...
  messages: {
    ...
    'widget.page.create.readonlyPageWidgetConfig': 'rendi in sola lettura la configurazione del widget sulla pagina',
    'widget.page.create.parentWidget': 'Widget genitore',
    ...
    'widget.help.readonlyPageWidgetConfig': 'Se abilitata, il widget manterrà la configurazione di default qui definita quando verrà configurato su una pagina',
    ...
    'tour.step.22.description': 'Fare clic sul pulsante Pubblica per salvare e pubblicare la prima pagina',
