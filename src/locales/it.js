export default {
  ...
  messages: {
    ...
    'componentRepository.component.help': 'Entando Hub è un marketplace da cui l\'utente può installare Widget, Componenti, UX Fragment, Template di Pagina, Modeli di Contenuto e Tipi di Contenuto',
