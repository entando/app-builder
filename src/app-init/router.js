...
export const ROUTE_CMS_CONTENT_TYPE = 'cmsContentType';
export const ROUTE_CMS_CONTENT_MODEL = 'cmsContentModel';
...
routerConfig(
  store,
  {
    ...
    routes: [
      ...
      { name: ROUTE_CMS_CONTENT_TYPE, path: '/cms/content-type' },
      { name: ROUTE_CMS_CONTENT_MODEL, path: '/cms/content-model' },
